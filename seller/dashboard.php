...
// Total Properties
$totalPropertiesQuery = $conn->query("
    SELECT COUNT(*) as total 
    FROM properties 
    WHERE seller_id = $seller_id
");
$totalProperties = $totalPropertiesQuery->fetch_assoc()['total'] ?? 0;

// Total Bookings
$totalBookingsQuery = $conn->query("
    SELECT COUNT(*) as total 
    FROM bookings b
...
<div class="container">
    ...
    <div class="dashboard-box">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-6 mb-3">
                <div class="stat-card">
                    ...
                    <h5 class="mt-2">Total Properties</h5>
        ...
        <div class="text-center mt-4">
            ...
            <a href="../property/add_property.php"
               class="btn btn-blue btn-modern m-2">
               <i class="bi bi-plus-circle"></i> Add Property
            </a>

            <a href="../property/property_list.php"
               class="btn btn-dark-custom btn-modern m-2">
               <i class="bi bi-list-ul"></i> My Properties
            </a>

            <a href="view_bookings.php"
               class="btn btn-green btn-modern m-2">
